 ...
 * @author Nandita
 */
public class AhemedabadElectricBill implements IElectricBill
{
     @Override
    public String createBill() 
    {
        double units;
         double pay=0;
            ...
            return "Ahemedabad Electric Bill Create Successfully";
        }

    @Override
    public String TermCond() 
    {
        return "Ahemedabad Electric Bill payment in 1 Month";
    }
}
